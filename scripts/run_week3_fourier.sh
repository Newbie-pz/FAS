...
TRAIN_OUTPUT_ROOT=${TRAIN_OUTPUT_ROOT:-outputs_week3/fourier}
CROSS_OUTPUT_ROOT=${CROSS_OUTPUT_ROOT:-outputs_week3_cross/fourier}
...
python summarize_cross_results.py \
  ...
  --csv_name fourier_cross_dataset_summary.csv \
  --md_name fourier_cross_dataset_summary.md

python compare_week3_results.py \
  --candidate "$CROSS_OUTPUT_ROOT/fourier_cross_dataset_summary.csv" \
  --method_name Fourier \
