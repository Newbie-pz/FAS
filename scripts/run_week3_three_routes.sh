...
echo "===================================================================="
echo "Week 3 unified experiment suite"
echo "1) Multi-source DG + ResNet18"
echo "2) DINOv2-Reg + Multi-source DG"
echo "3) DINOv2-Reg + SSDG-style DG"
...
for target in $TARGETS; do
  ...
  echo ""
  echo "===================================================================="
  echo "[ROUTE 1/3] Multi-source ResNet18 -> $target"
  echo "===================================================================="
  ...
  echo ""
  echo "===================================================================="
  echo "[ROUTE 2/3] DINOv2-Reg + Multi-source -> $target"
  echo "===================================================================="
  python train_vfm_multisource.py     --data_root "$DATA_ROOT"     --target_dataset "$target"     --output_dir "$OUT_ROOT/route2_dinov2_train"     --epochs "$DINO_EPOCHS"     --batch_size "$BATCH_SIZE"     --grad_accum 2     --backbone_lr 5e-6     --head_lr 5e-5     --max_train_frames_per_video "$MAX_FRAMES"     --max_val_frames_per_video "$MAX_FRAMES"     --feature_mode cls     --freeze_first_blocks 11     --loss focal     --focal_gamma 2.0     --patience 8
  ...
  echo ""
  echo "===================================================================="
  echo "[ROUTE 3/3] DINOv2-Reg + SSDG-style -> $target"
  echo "===================================================================="
...
echo ""
echo "===================================================================="
echo "Week 3 three-route suite completed."
